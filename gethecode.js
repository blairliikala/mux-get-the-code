...
class GetPlayerCode extends HTMLElement {
  ...
  css = `<style>
      .code_container {
        ...
        background-image: url("data:image/svg+xml;base64,${mux_logo}");
